...
#run both scripts
drowsiness_process = subprocess.Popen(["python","drow.py"])
alcohol_process = subprocess.Popen(["python","alcoholdet.py"])

#wait for both processes to complete
drowsiness_process.wait()
...
#create threads
thread1=threading.Thread(target=detect_drowsiness)
thread2=threading.Thread(target=detect_alcohol)
